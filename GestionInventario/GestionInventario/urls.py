...
urlpatterns = [
    ...
    path('correos/', views.gestionar_correos, name='gestionar_correos'),
    path('lista-correos/', views.listar_correos, name='listar_correos'),
    path('correos/editar/<int:correo_id>/', views.editar_correo, name='editar_correo'),
    path('correos/eliminar/<int:correo_id>/', views.eliminar_correo, name='eliminarcorreo'),
